    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/admin/headtechnique/takeattendance/**","/api/admin/headtechnique/checkattendance/**","/api/event/headculture/takeattendanceevent/**","/api/event/headculture/checkattendance/**","/api/admin/hr/viceheadclub/getmembers/**","/api/admin/hr/viceheadclub/getadmins/**","/api/admin/hr/viceheadclub/member/search").hasAnyRole("HeadCommunication","HeadClub","ViceHeadClub","Treasurer","HeadCulture","ViceHeadCulture","ViceHeadCommunication","HeadTechnique","ViceHeadTechnique")
                .anyRequest()
                .authenticated()
                .and()
                .oauth2Login()
