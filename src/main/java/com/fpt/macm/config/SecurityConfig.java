    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                // permit all
                .antMatchers("/api/admin/dashboard/getallupcomingactivities/**","/api/contact/getallcontact","/api/contact/getallsocialnetwork","/api/rule/getallrule","/api/semester/currentsemester","/api/semester/getTop3Semesters","/api/semester/getlistmonths","/api/commonschedule/**","/api/event/geteventbyid/**","/api/event/geteventsbyname","/api/event/geteventsbydate","/api/event/geteventsbysemester","/api/event/geteventsbysemesterandstudentid/**","/api/event/getalleventhasjoinedbystudentid/**","/api/event/getallupcomingevent","/api/event/getallongoingevent","/api/event/getallorganizingcommitteerolebyeventid/**","/api/event/getallrolebyeventid/**","/api/event/getallclosedevent","/api/eventschedule/geteventschedule","/api/eventschedule/geteventsessionbydate","/api/eventschedule/geteventschedulebyevent/**","/api/role/getroles","/api/trainingschedule/gettrainingschedule","/api/trainingschedule/gettrainingschedulebysemester/**","/api/trainingschedule/gettrainingsesionbydate","/api/profile","/api/event/registertojoinevent/**","/api/event/registertojoinorganizingcommittee/**","/api/event/canceltojoinevent/**","/api/notification/getallnotificationbystudentid/**","/api/notification/getallunreadnotificationbystudentid/**","/api/notification/marknotificationasread/**","/api/notification/markallnotificationasread/**","/api/notification/checkpaymentstatus/**","/api/tournament/headclub/tournament/**","/api/tournament/registertojoinorganizingcommittee/**","/api/tournament/registertojointournamentcompetitivetype/**","/api/tournament/registertojointournamentexhibitiontype/**","/api/tournament/getallusercompetitiveplayer/**","/api/tournament/getalluserexhibitionplayer/**","/api/tournament/getalluserorganizingcommittee/**","/api/tournament/getalltournamentbystudentid/**","/api/tournament/getallcompetitiveplayerbytype/**","/api/tournament/treasurer/getallcompetitivetype/**","/api/tournament/headclub/getallexhibitiontype/**","/api/tournament/headclub/getalltournamentorganizingcommittee/**","/api/tournament/headclub/getallorganizingcommitteerole","/api/tournamentschedule/headclub/tournamentschedule/**","/api/admin/hr/member/qrcode/create","/api/admin/hr/getallattendancestatusofuser/**","/api/event/getalleventbystudentid/**","/api/tournament/headclub/getallorganizingcommitteerole","/api/tournament/headclub/getallcompetitiveplayer/**","/api/tournament/headclub/getallexhibitionteam/**","/api/admin/headtechnique/getallattendancestatusbystudentidandsemester/**","/api/exhibition/getlistexhibitiontype/**","/api/exhibition/getlistexhibitionresult","/api/admin/hr/getbystudentid/**","/api/admin/hr/getallactivememberandcollaborator","/api/admin/hr/updateuser/**","/api/competitive/headclub/listmatchs/**").permitAll()
//                // HeadClub
