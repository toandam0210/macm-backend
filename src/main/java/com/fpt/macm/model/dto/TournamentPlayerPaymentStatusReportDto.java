...
public class TournamentPlayerPaymentStatusReportDto implements Comparable<TournamentPlayerPaymentStatusReportDto>{
	...
	@Override
	public int compareTo(TournamentPlayerPaymentStatusReportDto o) {
