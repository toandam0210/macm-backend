...
public class ExhibitionController {
	...
	ResponseEntity<ResponseMessage> registerTeam(@PathVariable(name = "exhibitionTypeId") int exhibitionTypeId,
		...
		return new ResponseEntity<ResponseMessage>(
				exhibitionTeamService.registerTeam(exhibitionTypeId, name, listStudentId), HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> getTeamByType(@PathVariable(name = "exhibitionTypeId") int exhibitionTypeId) {
		return new ResponseEntity<ResponseMessage>(exhibitionTeamService.getTeamByType(exhibitionTypeId),
				HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> getTop3TeamByType(@PathVariable(name = "exhibitionTypeId") int exhibitionTypeId) {
		return new ResponseEntity<ResponseMessage>(exhibitionTeamService.getTop3TeamByType(exhibitionTypeId),
				HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> spawnTimeAndArea(@PathVariable(name = "tournamentId") int tournamentId) {
		return new ResponseEntity<ResponseMessage>(exhibitionResultService.spawnTimeAndArea(tournamentId),
				HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> getListExhibitionType(@PathVariable(name = "tournamentId") int tournamentId) {
		return new ResponseEntity<ResponseMessage>(exhibitionTypeService.getAllExhibitionType(tournamentId),
				HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> getExhibitionResult(@RequestParam(defaultValue = "0") int exhibitionTypeId,
		...
		return new ResponseEntity<ResponseMessage>(
				exhibitionResultService.getListExhibitionResult(exhibitionTypeId, date), HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> updateExhibitionResult(
		...
		return new ResponseEntity<ResponseMessage>(
				exhibitionResultService.updateExhibitionResult(exhibitionTeamId, score), HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> listUserNotJoinExhibition(
		...
		return new ResponseEntity<ResponseMessage>(exhibitionTypeService.getListNotJoinExhibition(exhibitionTypeId),
				HttpStatus.OK);
	}
	...
	ResponseEntity<ResponseMessage> updateExhibitionTeam(@PathVariable(name = "exhibitionTeamId") int exhibitionTeamId,
		...
		return new ResponseEntity<ResponseMessage>(exhibitionTeamService.updateTeam(exhibitionTeamId, teamUsers), HttpStatus.OK);
	}
}
