...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
        .authorizeRequests()
        .antMatchers("/api/contact/getallcontact","/api/news/getallnews","/api/news/getnewsbyid/**","/api/rule/getallrule").permitAll()
        .antMatchers("/api/login","/api/admin/hr/**","/api/rule/**").hasAnyRole("ViceHeadClub","HeadClub")
        .antMatchers("/api/login").hasAnyRole("Treasurer")
        .antMatchers("/api/login").hasAnyRole("HeadCulture","ViceHeadCulture","HeadClub")
